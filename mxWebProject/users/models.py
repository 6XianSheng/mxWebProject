...
class EmailVerifyRecord(models.Model):
    ...
    send_type=models.CharField(verbose_name=u'验证码类型',choices=( ("register",u"注册"),
                                  ("forget",u"找回密码"),("update_email",u"修改邮箱") ),
                                max_length=30)
...
class Ban(models.Model):
    ...
    utl=models.URLField(max_length200,verbose_name=u"访问地址")
    index=models.IntegerField(default=100,verbose_name=u"播放顺序")
    add_time=models.DateTimeField(dafualt=datetime.now,verbose_name=u"添加时间")
